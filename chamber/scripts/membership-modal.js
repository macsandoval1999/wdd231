...
openButtons.forEach((openButton) => {
    openButton.addEventListener('click', () => {
        ...
        if (dialogID == 'np-modal') {
            ...
            membershipDescription.textContent = "Our Non-Profit Memnbership is designed to support the organizations that strengthen our community. This level provides affordable access to the Chamber's network, resources, and promotional outlets while honoring the unique budget needs of non-profit groups. Members at this level receive visibility through our online directory, discounted event participation, and opportunities to share their initiatives with the community. Whether you're a local charity, school, church, or community program, this membership connects you with leaders, volunteers, and partners, who can help you advance your mission.";
